# ROLE: AI 2 — Decision Architect and Independent Reconstructor (Start review)
# Project: Chicago 311 Dispatch Priority — Stages 1–2 Start Gate
# Blindness rule: Do NOT see or invent AI 3's review. Reconstruct from evidence below only.
# Do NOT design metrics, SQL, urgency formulas, or Stage 3 materials.

You are performing an independent Start review. Return ALL of the following numbered items in your reply:
...
Also state whether Start Gate looks ready from your reconstruction (Pass / Revise / Cannot yet frame) with brief reasons. Keep Stage 3 out of scope.
